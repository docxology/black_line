...
| Methodological | Question-first framing, traceability, small methods, visible failure, reruns, review, stewardship, and explicit limits are useful practices to try. | The practice registry plus the scholarship map in `docs/manuscript/01c_scholarship.md`. | This is a design synthesis and recommendation, not a causal finding that the instrument improves outcomes. |
